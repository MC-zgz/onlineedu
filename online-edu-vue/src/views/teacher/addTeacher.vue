  ...
  <div class="app-container" style="width: 700px;">
    <el-form label-width="120px">
      ...
      <el-form-item label="讲师排序">
        <el-input-number v-model="eduTeacher.sort" controls-position="right" :min="0" :max="2" />
      </el-form-item>
      ...
      @crop-upload-success：上传成功后的回调 -->
        <image-cropper v-show="imagecropperShow" :width="300" :height="300" :key="imagecropperKey"
          :url="BASE_API+'/ossservice/fileoss/uploadFile'" field="file" @close="close"
