          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：020-xxxxxx25(广州) 0755-xxxxx825(深圳)</span>
                <span>Email：info@atguigu.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2021课程版权均归在线教育系统所有 粤ICP备0000002号</span>
              </section>
            </section>
          </section>
...
<script>
  ...
  export default {
    ...
    methods: {
      showInfo() {
        let jsonStr = cookie.get('edu_ucenter')
        console.log(jsonStr);
        if (jsonStr) {
