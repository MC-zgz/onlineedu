                ...
                <li v-for="course in courseList" :key="course.id">
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      ...
                      <div class="cc-mask">
                        <a :href="'/course/'+course.id" target="_blank" title="开始学习" class="comm-btn c-btn-1">开始学习</a>
                      </div>
                    </section>
                    <h3 class="hLh30 txtOf mt10">
                      <a :href="'/course/'+course.id" target="_blank" title="course.title"
                ...
                <li v-for="teacher in teacherList" :key="teacher.id">
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :href="'/teacher/'+teacher.id" target="_blank" title="姚晨">
                        <img alt="teacher.name" :src="teacher.avatar">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a :href="'/teacher/'+teacher.id" target="_blank" title="teacher.name"
  ...
  export default {
    ...
    methods: {
      ...
      getCourseTeacherInfo() {
        index.getCourseAndTeacherList().then(res => {
