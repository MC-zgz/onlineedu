      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="courseWebVo.cover" :alt="courseWebVo.title" class="dis c-v-pic" height="357" width="640">
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <a href="#" @click="createOrderInfo()" title="立即购买" class="comm-btn c-btn-3">立即购买</a>
            </section>
          </section>
        </aside>
              ...
              <section class="stud-act-list">
                <ul style="height: auto;">
                  <li style="height: 80px;">
                    <div class="u-face">
                      <a href="#">
                        <img :src="courseWebVo.avatar" width="50" height="50" :alt="courseWebVo.avatar">
                      </a>
                    </div>
...
<script>
  ...
  export default {
    ...
    asyncData({ params, error }) {
      return course.getCourseWebInfo(params.id).then(res => {
